...
export function IdleScreen({ onStart }: IdleScreenProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-dvh bg-page px-6 py-12">
      {/* 마스코트 */}
      ...
      <button
        onClick={onStart}
        className="w-full max-w-xs py-4 rounded-2xl bg-brand text-white font-semibold text-base hover:bg-brand-hover active:scale-95 transition-all shadow-sm mb-3 cursor-pointer"
      >
        좋아, 시작!
      </button>
